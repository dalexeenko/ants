...
Git worktree support for OpenMgr agents — isolate branches with dedicated sessions.

## Status: Not Yet Integrated

This package is fully implemented (manager, plugin, tools, tests) but is **not yet wired into any consuming package** in the monorepo. No other package depends on `@openmgr/agent-worktree`.

It is kept here for future integration. To use it, you would need to:

1. Add `@openmgr/agent-worktree: workspace:*` as a dependency in the consuming package
